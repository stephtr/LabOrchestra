...
namespace PS4000AImports
{
    class Imports
    {
        ...
        public int MaxValue => 32767;

        public int QUAD_SCOPE => 4; // PicoScope with 4 channels
        public int OCTO_SCOPE => 8; // PicoScope with 8 channels

        public int SIG_GEN_BUFFER_SIZE => 16384;

        public Int64 AWG_PHASE_ACCUMULATOR => 4294967296;

        public int AWG_DAC_FREQUENCY => 80000000;
